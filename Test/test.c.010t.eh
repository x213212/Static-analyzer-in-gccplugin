...
foo3 (int * z)
{
  ...
  if (test != 0) goto <D.4476>; else goto <D.4477>;
  <D.4476>:
  _1 = malloc (1);
  _2 = (long int) _1;
  _3 = (int) _2;
...
foo2 (int z)
{
  ...
  *_7 = 100;
  ...
  foo3 (p3);
  if (tmp > 10) goto <D.4479>; else goto <D.4480>;
  <D.4479>:
  p99.2_8 = p99;
  _9 = p99.2_8 + 4;
  *_9 = 200;
...
child4 (int * data)
{
  ...
  pData = &data;
  test = &data;
  if (t != 0) goto <D.4488>; else goto <D.4489>;
  <D.4488>:
  data.13_1 = data;
  _2 = *data.13_1;
  data.14_3 = data;
...
child5 (void * data)
{
  ...
  pData = data;
  pData = pData + 4;
  if (c != 0) goto <D.4491>; else goto <D.4492>;
  <D.4491>:
  printf ("asdda%d\n", pData);
  goto <D.4493>;
  <D.4492>:
...
child6 (void * data, void * test)
{
  ...
  pData = test;
  pData = pData + 4;
  if (c != 0) goto <D.4494>; else goto <D.4495>;
  <D.4494>:
  pData = pData + 80;
  printf ("asdda%d\n", pData);
  goto <D.4496>;
...
child7 (void * data, void * test)
{
  ...
  pData = test;
  pData = pData + 4;
  if (c != 0) goto <D.4497>; else goto <D.4498>;
  <D.4497>:
  p98.16_2 = p98;
  _3 = p98.16_2 + 12;
  *_3 = 300;
...
main ()
{
  ...
  <D.4444>:
  size.22_10 = size;
  if (i < size.22_10) goto <D.4443>; else goto <D.4445>;
  <D.4445>:
  free (a);
  i = 0;
  goto <D.4448>;
  ...
  <D.4448>:
  size.23_19 = size;
  if (i < size.23_19) goto <D.4447>; else goto <D.4449>;
  <D.4449>:
  input[0] = 1;
  input[1] = 2;
  ...
  _26 = test != 0;
  _27 = _25 & _26;
  if (_27 != 0) goto <D.4502>; else goto <D.4503>;
  <D.4502>:
  child (q);
  *q = 10;
  free (q);
  ...
  *q = 20;
  ...
  if (staticTrue.25_29 != 0) goto <D.4505>; else goto <D.4506>;
  <D.4505>:
  data = malloc (400);
  if (data == 0B) goto <D.4507>; else goto <D.4508>;
  <D.4507>:
  exit (-1);
  <D.4508>:
  free (data);
  ...
  if (staticTrue.26_30 != 0) goto <D.4509>; else goto <D.4510>;
  <D.4509>:
  free (data);
  <D.4510>:
  _31 = foo5 (q, q);
