...
foo2 (int z)
{
  ...
  p4 = malloc (_3);
  *a2 = 10;
  if (tmp > 10) goto <D.4370>; else goto <D.4371>;
  <D.4370>:
...
;; Function child (child, funcdef_no=55, decl_uid=4339, cgraph_uid=55, symbol_order=57)
...
;; Function boo (boo, funcdef_no=56, decl_uid=4349, cgraph_uid=56, symbol_order=58)
...
printf (const char * restrict __fmt)
{
  ...
  D.4379 = __printf_chk (1, __fmt, __builtin_va_arg_pack ());
  goto <D.4380>;
  <D.4380>:
  return D.4379;
}
...
;; Function main (main, funcdef_no=60, decl_uid=4360, cgraph_uid=60, symbol_order=62)
