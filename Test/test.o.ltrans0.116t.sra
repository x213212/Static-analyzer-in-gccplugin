...
;; Function cmd_string_getc (cmd_string_getc, funcdef_no=1, decl_uid=4521, cgraph_uid=10, symbol_order=44)
...
;; Function xrealloc (xrealloc, funcdef_no=0, decl_uid=4522, cgraph_uid=11, symbol_order=43)
...
;; Function cmd_string_variable (cmd_string_variable, funcdef_no=2, decl_uid=4520, cgraph_uid=9, symbol_order=46)
...
;; Function cmd_string_string (cmd_string_string, funcdef_no=4, decl_uid=4519, cgraph_uid=8, symbol_order=47)
...
<L6> [63.42%]:
  ...
  *_3 = _4;
  ...
  <bb 15> [68.88%]:
  # buf_37 = PHI <buf_9(11), buf_34(13)>
  # len_17 = PHI <len_10(11), len_35(13)>

  <bb 19> [100.00%]:
  # buf_9 = PHI <buf_37(15), 0B(2)>
  # len_10 = PHI <len_17(15), 0(2)>
...
;; Function main (main, funcdef_no=5, decl_uid=3985, cgraph_uid=0, symbol_order=51) (executed once)
...
main ()
{
  ...
  _20 = __printf_chk (1, "%s: %s", "path", _64);
  _22 = len_21 + 1;
  line_23 = malloc (_22);
  memcpy (line_23, _64, len_21);
  _26 = line_23 + len_21;
  *_26 = 0;
  n_28 = n_27 + 1;
  ...
  *_34 = 0;
  ...
  <bb 12> [32.94%]:
  # buf_40 = PHI <line_23(10), buf_41(11)>
  _42 = *buf_40;
  ...
  <bb 15> [97.53%]:
  # argc_128 = PHI <argc_83(18), argc_83(17), argc_83(19), argc_129(23), argc_83(40), argc_83(42)>
  # argv_130 = PHI <argv_86(18), argv_86(17), argv_86(19), argv_94(23), argv_86(40), argv_86(42)>
  # buf_133 = PHI <buf_78(18), buf_78(17), buf_78(19), buf_132(23), buf_78(40), buf_112(42)>
  # len_170 = PHI <len_79(18), len_79(17), len_79(19), len_134(23), len_79(40), len_114(42)>

  <bb 16> [100.00%]:
  # argc_83 = PHI <argc_128(15), 0(14)>
  # argv_86 = PHI <argv_130(15), 0B(14)>
  # buf_78 = PHI <buf_133(15), 0B(14)>
  # len_79 = PHI <len_170(15), 0(14)>
  ch_73 = cmd_string_getc (buf_40, &p);
  switch (ch_73) <default: <L7> [14.29%], case -1: <L5> [14.29%], case 9: <L5> [14.29%], case 32: <L5> [14.29%], case 34: <L1> [14.29%], case 35: <L4> [14.29%], case 36: <L2> [14.29%], case 39: <L0> [14.29%], case 126: <L6> [14.29%]>

<L0> [14.29%]:
  t_74 = cmd_string_string (buf_40, &p, 39, 0);
  if (t_74 == 0B)
    goto <bb 43> (error); [2.50%]
  else
    goto <bb 15>; [97.50%]
...
<L5> [28.58%]:
  ...
  *_92 = buf_81;
  ...
  <bb 23> [28.58%]:
  # argc_129 = PHI <argc_83(21), argc_89(22)>
  # argv_94 = PHI <argv_86(21), argv_87(22)>
  # buf_132 = PHI <0B(21), 0B(22)>
  # len_134 = PHI <len_79(21), 0(22)>
  if (ch_93 != -1)
    goto <bb 15>; [97.50%]
  else
    goto <bb 24>; [2.50%]
  ...
  <bb 24> [0.71%]:
  # argc_175 = PHI <argc_129(23)>
  if (argc_175 != 0)
    goto <bb 25>; [92.50%]
  else
    goto <bb 43> (error); [7.50%]

  <bb 25> [4.58%]:
  # argc_61 = PHI <argc_105(26), argc_175(24)>
  _95 = *argv_94;
...
<L6> [14.29%]:
  ...
  <bb 37> [1.12%]:
  # home_153 = PHI <0B(35), home_149(36)>
  free (username_145);

  <bb 38> [2.33%]:
  # home_150 = PHI <home_139(31), home_144(33), home_153(37)>
  if (home_150 == 0B)
    goto <bb 40>; [7.92%]
  else
    goto <bb 39>; [92.08%]
  ...
  <bb 40> [2.49%]:
  # _152 = PHI <0B(32), 0B(34), 0B(38), _151(39)>
  if (_152 == 0B)
    goto <bb 43> (error); [2.50%]
  else
    goto <bb 15>; [97.50%]
...
<L7> [26.09%]:
  ...
  *_115 = _116;
  ...
  # argc_125 = PHI <argc_83(17), argc_83(18), argc_83(19), argc_105(26), argc_83(40), argc_83(41), argc_61(25), argc_175(24)>
  # argv_118 = PHI <argv_86(17), argv_86(18), argv_86(19), argv_94(26), argv_86(40), argv_86(41), argv_94(25), argv_94(24)>
  # buf_117 = PHI <buf_78(17), buf_78(18), buf_78(19), buf_132(26), buf_78(40), buf_78(41), buf_132(25), buf_132(24)>
error [2.50%]:
out [2.50%]:
  free (buf_117);
  if (argv_118 != 0B)
  ...
  <bb 45> [10.38%]:
  # i_62 = PHI <i_124(45), i_58(44)>
  _120 = (long unsigned int) i_62;
  _121 = _120 * 8;
  _122 = argv_118 + _121;
  _123 = *_122;
  free (_123);
  ...
  <bb 48> [5.96%]:
  # n_68 = PHI <n_28(13), n_28(9), n_28(47)>
  # buf_69 = PHI <buf_40(13), _64(9), buf_40(47)>
  # len_70 = PHI <len_29(13), len_29(9), len_29(47)>

  <bb 49> [6.97%]:
  # n_27 = PHI <n_68(48), 0(3)>
  # buf_55 = PHI <buf_69(48), buf_71(D)(3)>
  # len_14 = PHI <len_70(48), len_72(D)(3)>
  _54 = (int) len_14;
